...
- (void)testWhenVerifyingForMethodWithDifferentStructParametersThenHelpfulMessageIsReturned {
    ...
    result = SBLVerifyImpl(atLeast(1), nil, [mock methodWithPrimitiveReference:(NSInteger *)2]);
    XCTAssertFalse(result.successful);
    ...
    result = SBLVerifyImpl(atLeast(1), nil, [mock methodWithCGRect:CGRectMake(0,1,0,1)]);
    XCTAssertFalse(result.successful);
